...
const STEPS = [
  {
    ...
    description:
      "Paste your URL. That's the only input we need — no forms, no manual setup.",
  },
  {
    number: "02",
    icon: ScanSearch,
    ...
    description:
      "Pages, services, pricing, FAQs, brand tone — organized into structured knowledge in minutes.",
  },
  {
    number: "03",
    icon: Sparkles,
    title: "Your assistant goes live",
    description:
      "A chatbot that already sounds like you, knows your business, and is ready to install.",
  },
];
